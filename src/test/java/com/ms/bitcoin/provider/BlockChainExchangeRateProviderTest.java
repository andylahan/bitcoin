...
import static com.ms.bitcoin.provider.BlockChainExchangeRateProvider.RATE_KEY;
import static com.ms.bitcoin.provider.BlockChainExchangeRateProvider.SELL_PRICE_KEY;
import static com.ms.bitcoin.provider.BlockChainExchangeRateProvider.URL;
...
@PrepareForTest({BlockChainExchangeRateProvider.class})
public class BlockChainExchangeRateProviderTest {
    ...
    public void getExchangeRates() throws Exception {
        ...
        BlockChainExchangeRateProvider blockChainExchangeRateProvider = new BlockChainExchangeRateProvider();
        Double result = blockChainExchangeRateProvider.getSellPrice();
